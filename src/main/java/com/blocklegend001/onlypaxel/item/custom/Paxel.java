...
public class Paxel extends DiggerItem {
    ...
    public Paxel(Tier material, int attackDamage, float attackSpeed) {
        super(
                attackDamage,
                attackSpeed,
                material,
                ModTags.Blocks.PAXEL_MINEABLE,
                createSettings(material)
        );
    }

    private static Item.Properties createSettings(Tier material) {
        Item.Properties settings = new Item.Properties().durability(material.getUses());

        if (material == ModToolMaterials.NETHERITE_PAXEL) {
    ...
    private static final class Axe extends AxeItem {
        ...
        private Axe(Tier pTier, int attackDamage, float attackSpeed, Properties pProperties) {
    ...
    private static final class Shovel extends ShovelItem {
        ...
        private Shovel(Tier pTier, int attackDamage, float attackSpeed, Properties pProperties) {
            super(pTier, attackDamage, attackSpeed, pProperties);
        }
    }
}