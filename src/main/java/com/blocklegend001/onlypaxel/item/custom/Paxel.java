...
public class Paxel extends DiggerItem {
    ...
    public Paxel(ToolMaterial tier, float attackDamage, float attackSpeed, Properties properties) {
        super(tier, ModTags.Blocks.PAXEL_MINEABLE, attackDamage, attackSpeed, properties);
    }
