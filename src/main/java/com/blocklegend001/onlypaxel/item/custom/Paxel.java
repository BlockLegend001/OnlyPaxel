...
public class Paxel extends DiggerItem {
    ...
    public Paxel(Tier tier, float attackDamage, float attackSpeed) {
        super(tier, ModTags.Blocks.PAXEL_MINEABLE, createProperties(tier, attackDamage, attackSpeed));
    }

    private static Item.Properties createProperties(Tier tier, float attackDamage, float attackSpeed) {
        Item.Properties properties = new Item.Properties()
                .attributes(Paxel.createAttributes(tier, attackDamage, attackSpeed))
                .component(DataComponents.TOOL, tier.createToolProperties(ModTags.Blocks.PAXEL_MINEABLE));
