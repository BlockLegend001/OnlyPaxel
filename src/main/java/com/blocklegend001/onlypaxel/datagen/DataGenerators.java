...
@Mod.EventBusSubscriber(modid = OnlyPaxel.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class DataGenerators {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        generator.addProvider(event.includeClient(), new ModModelProvider(packOutput, OnlyPaxel.MODID));
    }
}
